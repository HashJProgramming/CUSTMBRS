...
<head>
    ...
    <title>Cottages Available - CUSTMBRS</title>
            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Cottage Available</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-user fa-sm text-white-50"></i>&nbsp;Check Cottage Available</a>
                    </div>
                            ...
                            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                                <?php 
                                    if (isset($_GET['start']) && isset($_GET['end'])) {
                                        cottage_available_list($_GET['start'], $_GET['end']); 
                                    }
                                ?>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="cottage-available.php" method="get" novalidate>
                    <div class="mb-1"><label class="form-label">Datetime (start, end)</label>
                            <div class="container">
                                <div class="row">
